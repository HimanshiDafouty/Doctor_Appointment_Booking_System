...
const MyProfile = () => {
    ...
    const [image, setImage] = useState(false) // selected profile image
    ...
    const updateUserProfileData = async () => {
        ...
        try {
            ...
            if (data.success) {
                ...
                await loadUserProfileData() // reloading
                setIsEdit(false)
                setImage(false)
            } else {
    ...
    return userData ? (
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
            ...
            {/* label: clickable image upload area */}
            ...
            {isEdit
                ? <label htmlFor='image' > 
                    ...
                    {/* updates the state with the selected image */}
                </label>
