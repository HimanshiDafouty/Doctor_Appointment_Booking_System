...
const Appointment = () => {
    ...
    const [docInfo, setDocInfo] = useState(null) // doctor details
    ...
    const getAvailableSolts = async () => {
        ...
        setDocSlots([]) // clearing the previous appointment slots
        ...
        for (let i = 0; i < 7; i++) {
            ...
            if (today.getDate() === currentDate.getDate()) {
                // If today, start from the next available hour or 10 AM
